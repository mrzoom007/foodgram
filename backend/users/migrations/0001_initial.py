    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator(message='Ошибка валидации', regex='^[\\w.@+-]+\\Z')], verbose_name='Логин')),
